...
function About() {
  return (
    ...
    <h2 className="h2">
      Our Story</h2>
    <p className="p">
     We are a small group of somewhat compitant people who consist of Asher, Moheen, Jools, Junaid and James. We have come together to create a cinema site after the almighty Morgan told us to and its also our passion </p>
    <h2 className="h2">
      Where to find us</h2>
      <a className="a"
